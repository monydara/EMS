...
--
-- Dumping data for table `sdn_acc_key_accounts`
--

LOCK TABLES `sdn_acc_key_accounts` WRITE;
/*!40000 ALTER TABLE `sdn_acc_key_accounts` DISABLE KEYS */;
/*!40000 ALTER TABLE `sdn_acc_key_accounts` ENABLE KEYS */;
UNLOCK TABLES;

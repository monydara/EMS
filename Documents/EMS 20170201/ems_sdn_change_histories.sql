...
--
-- Dumping data for table `sdn_change_histories`
--

LOCK TABLES `sdn_change_histories` WRITE;
/*!40000 ALTER TABLE `sdn_change_histories` DISABLE KEYS */;
/*!40000 ALTER TABLE `sdn_change_histories` ENABLE KEYS */;
UNLOCK TABLES;

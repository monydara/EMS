...
--
-- Dumping data for table `sdn_class_students`
--

LOCK TABLES `sdn_class_students` WRITE;
/*!40000 ALTER TABLE `sdn_class_students` DISABLE KEYS */;
/*!40000 ALTER TABLE `sdn_class_students` ENABLE KEYS */;
UNLOCK TABLES;

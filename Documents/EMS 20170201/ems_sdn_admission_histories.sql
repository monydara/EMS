...
--
-- Dumping data for table `sdn_admission_histories`
--

LOCK TABLES `sdn_admission_histories` WRITE;
/*!40000 ALTER TABLE `sdn_admission_histories` DISABLE KEYS */;
/*!40000 ALTER TABLE `sdn_admission_histories` ENABLE KEYS */;
UNLOCK TABLES;

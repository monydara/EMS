...
--
-- Dumping data for table `sdn_student_requests`
--

LOCK TABLES `sdn_student_requests` WRITE;
/*!40000 ALTER TABLE `sdn_student_requests` DISABLE KEYS */;
/*!40000 ALTER TABLE `sdn_student_requests` ENABLE KEYS */;
UNLOCK TABLES;

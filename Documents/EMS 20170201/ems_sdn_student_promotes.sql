...
--
-- Dumping data for table `sdn_student_promotes`
--

LOCK TABLES `sdn_student_promotes` WRITE;
/*!40000 ALTER TABLE `sdn_student_promotes` DISABLE KEYS */;
/*!40000 ALTER TABLE `sdn_student_promotes` ENABLE KEYS */;
UNLOCK TABLES;

...
--
-- Dumping data for table `acc_group_accounts`
--

LOCK TABLES `acc_group_accounts` WRITE;
/*!40000 ALTER TABLE `acc_group_accounts` DISABLE KEYS */;
INSERT INTO `acc_group_accounts` VALUES (1,'001','Group Finance ','TC',NULL,NULL,NULL,NULL,NULL,'O',1,NULL,NULL);
/*!40000 ALTER TABLE `acc_group_accounts` ENABLE KEYS */;
UNLOCK TABLES;

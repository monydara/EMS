...
--
-- Dumping data for table `acd_standard_divisions`
--

LOCK TABLES `acd_standard_divisions` WRITE;
/*!40000 ALTER TABLE `acd_standard_divisions` DISABLE KEYS */;
/*!40000 ALTER TABLE `acd_standard_divisions` ENABLE KEYS */;
UNLOCK TABLES;

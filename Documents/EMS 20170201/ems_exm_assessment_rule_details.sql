...
--
-- Dumping data for table `exm_assessment_rule_details`
--

LOCK TABLES `exm_assessment_rule_details` WRITE;
/*!40000 ALTER TABLE `exm_assessment_rule_details` DISABLE KEYS */;
/*!40000 ALTER TABLE `exm_assessment_rule_details` ENABLE KEYS */;
UNLOCK TABLES;

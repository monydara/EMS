...
--
-- Dumping data for table `acc_tc_level_plans`
--

LOCK TABLES `acc_tc_level_plans` WRITE;
/*!40000 ALTER TABLE `acc_tc_level_plans` DISABLE KEYS */;
/*!40000 ALTER TABLE `acc_tc_level_plans` ENABLE KEYS */;
UNLOCK TABLES;

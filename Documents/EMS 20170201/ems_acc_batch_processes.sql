...
--
-- Dumping data for table `acc_batch_processes`
--

LOCK TABLES `acc_batch_processes` WRITE;
/*!40000 ALTER TABLE `acc_batch_processes` DISABLE KEYS */;
INSERT INTO `acc_batch_processes` VALUES (1,1,'001','Batch Name',NULL,NULL,'N',1,'2016-02-27 06:42:01','2016-02-27 06:42:01');
/*!40000 ALTER TABLE `acc_batch_processes` ENABLE KEYS */;
UNLOCK TABLES;

...
--
-- Dumping data for table `sdn_additional_fees`
--

LOCK TABLES `sdn_additional_fees` WRITE;
/*!40000 ALTER TABLE `sdn_additional_fees` DISABLE KEYS */;
/*!40000 ALTER TABLE `sdn_additional_fees` ENABLE KEYS */;
UNLOCK TABLES;

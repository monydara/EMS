...
--
-- Dumping data for table `acd_class_wus`
--

LOCK TABLES `acd_class_wus` WRITE;
/*!40000 ALTER TABLE `acd_class_wus` DISABLE KEYS */;
/*!40000 ALTER TABLE `acd_class_wus` ENABLE KEYS */;
UNLOCK TABLES;

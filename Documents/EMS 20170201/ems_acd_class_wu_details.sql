...
--
-- Dumping data for table `acd_class_wu_details`
--

LOCK TABLES `acd_class_wu_details` WRITE;
/*!40000 ALTER TABLE `acd_class_wu_details` DISABLE KEYS */;
/*!40000 ALTER TABLE `acd_class_wu_details` ENABLE KEYS */;
UNLOCK TABLES;

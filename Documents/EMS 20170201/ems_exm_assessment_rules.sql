...
--
-- Dumping data for table `exm_assessment_rules`
--

LOCK TABLES `exm_assessment_rules` WRITE;
/*!40000 ALTER TABLE `exm_assessment_rules` DISABLE KEYS */;
/*!40000 ALTER TABLE `exm_assessment_rules` ENABLE KEYS */;
UNLOCK TABLES;

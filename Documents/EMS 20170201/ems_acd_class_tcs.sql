...
--
-- Dumping data for table `acd_class_tcs`
--

LOCK TABLES `acd_class_tcs` WRITE;
/*!40000 ALTER TABLE `acd_class_tcs` DISABLE KEYS */;
/*!40000 ALTER TABLE `acd_class_tcs` ENABLE KEYS */;
UNLOCK TABLES;

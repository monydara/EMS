...
--
-- Dumping data for table `sdn_documents`
--

LOCK TABLES `sdn_documents` WRITE;
/*!40000 ALTER TABLE `sdn_documents` DISABLE KEYS */;
/*!40000 ALTER TABLE `sdn_documents` ENABLE KEYS */;
UNLOCK TABLES;

...
--
-- Dumping data for table `sdn_class_tc_students`
--

LOCK TABLES `sdn_class_tc_students` WRITE;
/*!40000 ALTER TABLE `sdn_class_tc_students` DISABLE KEYS */;
/*!40000 ALTER TABLE `sdn_class_tc_students` ENABLE KEYS */;
UNLOCK TABLES;

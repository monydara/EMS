...
--
-- Dumping data for table `acd_tm_courses`
--

LOCK TABLES `acd_tm_courses` WRITE;
/*!40000 ALTER TABLE `acd_tm_courses` DISABLE KEYS */;
/*!40000 ALTER TABLE `acd_tm_courses` ENABLE KEYS */;
UNLOCK TABLES;

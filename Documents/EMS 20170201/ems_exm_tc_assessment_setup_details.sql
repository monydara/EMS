...
--
-- Dumping data for table `exm_tc_assessment_setup_details`
--

LOCK TABLES `exm_tc_assessment_setup_details` WRITE;
/*!40000 ALTER TABLE `exm_tc_assessment_setup_details` DISABLE KEYS */;
/*!40000 ALTER TABLE `exm_tc_assessment_setup_details` ENABLE KEYS */;
UNLOCK TABLES;

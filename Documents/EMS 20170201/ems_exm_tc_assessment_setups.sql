...
--
-- Dumping data for table `exm_tc_assessment_setups`
--

LOCK TABLES `exm_tc_assessment_setups` WRITE;
/*!40000 ALTER TABLE `exm_tc_assessment_setups` DISABLE KEYS */;
/*!40000 ALTER TABLE `exm_tc_assessment_setups` ENABLE KEYS */;
UNLOCK TABLES;

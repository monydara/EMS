...
--
-- Dumping data for table `acd_room_items`
--

LOCK TABLES `acd_room_items` WRITE;
/*!40000 ALTER TABLE `acd_room_items` DISABLE KEYS */;
/*!40000 ALTER TABLE `acd_room_items` ENABLE KEYS */;
UNLOCK TABLES;

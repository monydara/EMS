...
--
-- Dumping data for table `acc_ccy_rate_histories`
--

LOCK TABLES `acc_ccy_rate_histories` WRITE;
/*!40000 ALTER TABLE `acc_ccy_rate_histories` DISABLE KEYS */;
/*!40000 ALTER TABLE `acc_ccy_rate_histories` ENABLE KEYS */;
UNLOCK TABLES;

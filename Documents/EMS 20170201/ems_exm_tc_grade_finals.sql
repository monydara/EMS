...
--
-- Dumping data for table `exm_tc_grade_finals`
--

LOCK TABLES `exm_tc_grade_finals` WRITE;
/*!40000 ALTER TABLE `exm_tc_grade_finals` DISABLE KEYS */;
/*!40000 ALTER TABLE `exm_tc_grade_finals` ENABLE KEYS */;
UNLOCK TABLES;

...
--
-- Dumping data for table `exm_tc_assessment_types`
--

LOCK TABLES `exm_tc_assessment_types` WRITE;
/*!40000 ALTER TABLE `exm_tc_assessment_types` DISABLE KEYS */;
/*!40000 ALTER TABLE `exm_tc_assessment_types` ENABLE KEYS */;
UNLOCK TABLES;

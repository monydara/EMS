...
--
-- Dumping data for table `exm_tc_attendances`
--

LOCK TABLES `exm_tc_attendances` WRITE;
/*!40000 ALTER TABLE `exm_tc_attendances` DISABLE KEYS */;
/*!40000 ALTER TABLE `exm_tc_attendances` ENABLE KEYS */;
UNLOCK TABLES;

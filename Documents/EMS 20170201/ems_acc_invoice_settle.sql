...
--
-- Dumping data for table `acc_invoice_settle`
--

LOCK TABLES `acc_invoice_settle` WRITE;
/*!40000 ALTER TABLE `acc_invoice_settle` DISABLE KEYS */;
/*!40000 ALTER TABLE `acc_invoice_settle` ENABLE KEYS */;
UNLOCK TABLES;

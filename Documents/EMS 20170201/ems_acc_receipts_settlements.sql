...
--
-- Dumping data for table `acc_receipts_settlements`
--

LOCK TABLES `acc_receipts_settlements` WRITE;
/*!40000 ALTER TABLE `acc_receipts_settlements` DISABLE KEYS */;
/*!40000 ALTER TABLE `acc_receipts_settlements` ENABLE KEYS */;
UNLOCK TABLES;

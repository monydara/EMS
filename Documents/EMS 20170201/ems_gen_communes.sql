...
--
-- Dumping data for table `gen_communes`
--

LOCK TABLES `gen_communes` WRITE;
/*!40000 ALTER TABLE `gen_communes` DISABLE KEYS */;
/*!40000 ALTER TABLE `gen_communes` ENABLE KEYS */;
UNLOCK TABLES;

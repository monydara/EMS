...
--
-- Dumping data for table `sdn_fee_discounts`
--

LOCK TABLES `sdn_fee_discounts` WRITE;
/*!40000 ALTER TABLE `sdn_fee_discounts` DISABLE KEYS */;
/*!40000 ALTER TABLE `sdn_fee_discounts` ENABLE KEYS */;
UNLOCK TABLES;

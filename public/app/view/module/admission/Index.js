Ext.define('ExtDesktop.view.module.admission.Index', {
        ...
        Ext.applyIf(me, {
            ...
            columns: [{
                    ...
                    renderer: function(value, raw, record) {
                        ...
                        // "<div style='padding-bottom:5px'>St. Code <br> </div>"+
                        ...
                        "<div style='padding-bottom:5px'>Status</div></div>";
                        var infoString = labelDiv + "<div style='display:inline-block; width:200px;'> </b>" +
                            ...
                            // "<div style='padding-bottom:5px'>:<span style='color:blue'> " + studentObj.student_code +"</span>"+"</div>"+
                    ...
                    renderer: function(value, raw, record) {
                        ...
                        "<div style='padding-bottom:5px'><b> Degree   </div>"+
                        "<div style='padding-bottom:5px'> Course </div>"+
                        "<div style='padding-bottom:5px'> Session  </div>"+
                        "<div style='padding-bottom:5px'> Admission No  </div>"+
                        "<div style='padding-bottom:5px'> Reference No  </div>"+
                        "<div style='padding-bottom:5px'> Term </div></div>";
                        reference_no = data.reference_no == null ? "": data.reference_no ;

                        var infoString = labelDiv +
                             "<div style='display:inline-block; width:200px;'></u></b>"+
                    ...
                    renderer: function(value, raw, record) {
                        ...
                        var infoString = labelDiv + "<div style='display:inline-block; width:200px;'>"+
                            "<div style='padding-bottom:5px'>: " +data.account_no +"</div>"+
                            "<div style='padding-bottom:5px'>: " + data.cycle_name +"</div>"+
                            "<div style='padding-bottom:5px'>: " + data.balance +"</div>"+
                            "<div style='padding-bottom:5px'>: " + data.account_status +"</div>"+
                            "</div></div>";
                        return infoString;
                    }
                },{
                    ...
                    items:[
                        {
                            ...
                            handler:function(grid , rowIndex){
                                var ctrl = ExtDesktop.app.getController("Admission");
